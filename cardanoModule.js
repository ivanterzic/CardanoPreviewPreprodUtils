   ...
   */
    ...
    constructor(options){
        ...
        this.cardanoCLIInterface = new CardanocliJs({
            ...
            dir : this.dir, 
            network : "testnet-magic " + this.magic
        })
     ...
     * @param {int=} magic - 1 for preprod testnet, 2 for preview testnet
    ...
    async searchMetadataByTxHash(hash) {
        return this.BlockfrostAPI.txsMetadata(hash).then((res) => {return res}).catch((err) => {return err})
    }

}

module.exports = CardanoTestnetsUtils